...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/donos.svg
  SvgGenImage get donos => const SvgGenImage('assets/svg/donos.svg');

  /// File path: assets/svg/main.svg
  SvgGenImage get main => const SvgGenImage('assets/svg/main.svg');

  /// File path: assets/svg/motivation.svg
  SvgGenImage get motivation => const SvgGenImage('assets/svg/motivation.svg');

  /// List of all assets
  List<SvgGenImage> get values => [donos, main, motivation];
}
